      ...
      <div className="hero ">
        <div className="hero-content flex-col ">
          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            ...
            {/* ------------------ */}
            <p class="mx-4 mb-0 text-center font-semibold text-blue-600 dark:text-white">
              Or
            </p>
            <div class="flex flex-row items-center justify-center lg:justify-start">
              ...
              <button
                ...
                class="mx-1 h-9 w-9 rounded-full bg-primary uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] )]"
              >
                <svg
